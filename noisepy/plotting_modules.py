...
def plot_substack_all(
    sfile, freqmin, freqmax, ccomp, disp_lag=None, savefig=False, sdir=None
):
    """
...
def plot_all_moveout_1D_1comp(
    sfiles, sta, dtype, freqmin, freqmax, ccomp, disp_lag=None, savefig=False, sdir=None
):
    """
...
def plot_all_moveout_1D_9comp(
    sfiles, sta, dtype, freqmin, freqmax, disp_lag=None, savefig=False, sdir=None
):
    """
    display the moveout waveforms of the cross-correlation functions stacked for all time chuncks.
